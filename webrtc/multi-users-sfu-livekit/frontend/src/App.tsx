...
function App() {
  ...
  const { connected, localVideoRef, remoteTracks, chatMessages, sendChat, participantCount } =
  ...
  if (!roomId) {
    return (
      <div style={styles.entry}>
        <h1 style={styles.title}>LiveKit 다자간 화상 통화</h1>
  ...
  return (
    <div style={styles.app}>
      <header style={styles.header}>
        <h1 style={styles.headerTitle}>LiveKit 다자간 화상 통화</h1>
      ...
      <div style={styles.main}>
        <div style={styles.videoSection}>
          <VideoGrid localVideoRef={localVideoRef} remoteTracks={remoteTracks} />
        </div>
